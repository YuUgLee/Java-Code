...
class Main {
  /**
	 * Hero visits the store; Store sells Health Potions, and Keys; Store buys anything in the hero's inventory
	 */
    ...
    while(another) {
      ...
      if (choice == 1) {
        ...
        while(a) {
          ...
          System.out.format("+------------------+-----------+%n");
          System.out.println("What do you want to buy: (0 to return to Menu)");
          ...
          if (a != false) {
            System.out.print("1. Buy Another Item? (Y/N) ");
  ...
  /**
	 ...
	 * @param h is the hero object
	 * @param e is the enemy generated
    ...
    //Magic Attack
      ...
      if (index > -1) {
        ...
        System.out.println(i.getName() + " blocked the attack!");
	...
	public static void main(String[] args) {
      ...
      //store and start
        ...
        //hero has key
          ...
          String[] lines = hero.itemsToString().split("\r\n|\r|\n");
          int index = 0;
          for (int i = 0; i < lines.length; i++) {
          ...
          System.out.println("~~~ Level " + mapNum + " cleared! ~~~");
